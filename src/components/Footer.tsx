...
const Footer = () => {
  return (
    <footer id="contact" className="bg-black/50 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="#" className="p-2 rounded-full bg-scryptex-purple/20 hover:bg-scryptex-purple/30 transition-colors">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Get the latest updates and news about Scryptex</p>
            <div className="flex gap-2">
              <Input 
                type="email" 
                placeholder="Enter your email" 
                className="border-white/10 bg-black/20 backdrop-blur-md" 
              />
              <Button className="bg-scryptex-purple hover:bg-scryptex-darkpurple transition-colors">
