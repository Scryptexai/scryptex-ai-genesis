...
const DashboardSidebar = ({ isOpen, setIsOpen }: SidebarProps) => {
  ...
  const mainNavItems = [
    ...
    { name: "Analyze AI", path: "/dashboard/ai-research-hub", icon: Brain },
    { name: "Airdrop Update", path: "/dashboard/airdrop-radar", icon: Gift },
    { name: "Saved Projects", path: "/dashboard/saved-projects", icon: Bookmark },
    { name: "Referral & Points", path: "/dashboard/referrals", icon: Star, disabled: true },
  ...
  return (
    <>
      ...
      <motion.button
        className="fixed top-4 left-4 z-30 md:hidden bg-purple-900/80 backdrop-blur p-2 rounded-lg border border-purple-700/50 shadow-lg"
      ...
      >
        ...
        {/* Logo */}
        <div className="p-6 border-b border-purple-900/30 relative">
          <motion.div 
            className="absolute -z-10 top-0 left-0 right-0 bottom-0 bg-gradient-to-b from-purple-900/40 to-transparent"
            animate={{ 
              opacity: [0.3, 0.5, 0.3],
            }}
        ...
        <div className="px-4 py-4">
          <div className="bg-purple-900/20 rounded-lg p-3 border border-purple-900/30">
            <div className="text-xs text-gray-400">MY POINTS</div>
            <div className="text-lg font-bold text-purple-300">2,450</div>
            <div className="w-full h-1.5 bg-purple-900/50 rounded-full mt-2 overflow-hidden">
              <motion.div 
        ...
        <div className="absolute bottom-0 left-0 w-full border-t border-purple-900/30 p-4">
          <div className="flex flex-col gap-2">
            <button 
              onClick={toggleTheme}
              className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors px-4 py-2 rounded-lg hover:bg-purple-900/20"
            >
              <motion.div
            ...
            >
              ...
              <span className="text-sm">Help / Discord</span>
            </a>
